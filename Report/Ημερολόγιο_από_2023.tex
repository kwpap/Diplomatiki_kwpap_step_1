...
\begin{itemize}[label={}]
	...
	\begin{tabular}{c|ccc|ccc}
		...
		& &\textbf{Firm 1 }  && & \textbf{Firm 2} &  \\
		$\hbar$
		abatement function &&$ x^2$ &  &&$ x^2$  & \\
		production cost && 0 & & & 0 &  \\
		permit cost && 5 && & 5 & \\
		free allocation &&$ 0.02 \cdot \ production$ &&  & $0.06 \cdot \ production$ &  \\
		product price && $10-0.1x $&  & &$10-0.1x$ &  \\
		output  & \textcolor{blue}{17.00}  &$\neq$ &\textcolor{blue}{16.33}  & \textcolor{magenta}{16.99}  & $\neq$& \textcolor{magenta}{18.33}  \\
		emission & \textcolor{red}{14.50}  & $\neq$&\textcolor{red}{13.83}  & \textcolor{pink}{14.49}  &$\neq$& \textcolor{pink}{15.83}  \\
		profit & 35.15 & $\neq$& 32.93 & 35.14 &$\neq$& 39.85
	\end{tabular}
	Το πολύ ενδιαφέρον είναι πως οι δύο διαφορετικές εκτελέσεις του αλγορίθμου έχουν να κάνουν ειλικρινά με κάτι τυχαίο που δεν είμαι σε θέση να καταλάβω. Κάνουν ακριβώς το ίδιο πράγμα. Έχουν ακριβώς τα ίδια δεδομένα, αλλάζει μόνο το πού είναι αποθηκευμένα τα δεδομένα. Το οποίο δεν είναι λογικό, οπότε θέλει παραπάνω ψάξιμο.\\
	\textbf{Άρα αυτός ο τρόπος είναι εντελώς λάθος ή περιλαμβάνει κάποιο λάθος!}
	\item \lbrack 31/8/24 \rbrack Ναι... Μάλλον εγώ δεν μπορώ να καταλάβω τι συμβαίνει. Δεν έχω κάνει ενδιάμεσα καν commit. Δεν ξέρω αν το gurobi είχε κάποιο πρόβλημα και λύθηκε την επόμενη μέρα, έκανα τα ίδια πράγματα και λύθηκε όλο μόνο του. Έκανα και δοκιμές και έβγαιναν οι ίδιες τιμές, ακόμα και αν ο ορισμός του προγράμματος ήταν διαφορετικός. 
...
\begin{tabular}{rr|rr}
	...
	% 1 & 731.034483 & 95.496944 \\
	% 2 & 1062.068966 & 74.123818 \\
	% 3 & 1393.103448 & 53.205440 \\
	% 4 & 1724.137931 & 31.832315 \\
	% 5 & 2055.172414 & 11.368684 \\
	% 6 & 2386.206897 & 0.454747 \\
	% 7 & 2717.241379 & 0.454747 \\
	% 8 & 3048.275862 & 0.454747 \\
	% 9 & 3379.310345 & 0.454747 \\
	% 10 & 3710.344828 & 0.454747 \\
	% 11 & 4041.379310 & 0.454747 \\
	% 12 & 4372.413793 & 0.454747 \\
	% 13 & 4703.448276 & 0.454747 \\
	% 14 & 5034.482759 & 0.454747 \\
	% 15 & 5365.517241 & 0.454747 \\
	% 16 & 5696.551724 & 0.454747 \\
	% 17 & 6027.586207 & 0.454747 \\
	% 18 & 6358.620690 & 0.454747 \\
	% 19 & 6689.655172 & 0.454747 \\
	% 20 & 7020.689655 & 0.454747 \\
	% 21 & 7351.724138 & 0.454747 \\
	% 22 & 7682.758621 & 0.454747 \\
	% 23 & 8013.793103 & 0.454747 \\
	% 24 & 8344.827586 & 0.454747 \\
	% 25 & 8675.862069 & 0.454747 \\
	% 26 & 9006.896552 & 0.454747 \\
	% 27 & 9337.931034 & 0.454747 \\
	% 28 & 9668.965517 & 0.454747 \\
	% 29 & 10000.000000 & 0.454747 \\
	\bottomrule
\end{tabular}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.48\linewidth} % Adjust width to fit side-by-side
		\centering
	...
	\hfill % Adds space between the two figures
		\begin{subfigure}[b]{0.48\linewidth} % Centered, larger width
		\centering
	...
	\vspace{1cm} % Optional: Adjust vertical space between rows
...
\section{12-23/9/24}
Ειλικρίνα δεν ξέρω πόσες μέρες έρχομαι κάθε μέρα στο ΜΟΠ. Δεν ξέρω πόση δουλειά έχω κάνει, μάλλον όχι πολλή... Ας μπουν εδώ τα καινούρια όποια και αν είναι αυτά.

\section{5/10/24}
Τώρα και αν έχουν περάσει πολλές μέρες που κάθε μέρα είμαι στο ΜΟΠ χωρ΄ςι να έχω κάνει εντυπωσιακή πρόοδο. Θα προσπαθήσω να κάνω μία λίστα με τα σημαντικά που έχουν συμβεί και ελπίζω να μην νιώθω άσχημα μετά από αυτό. Α, έχασα και τις σημειώσεις μου από τις τελευταίες 3 εβδομάδες οπότε αυτά είναι μόνο όσα θυμάμαι.

\begin{enumerate}
	\item Νομίζω αυτό που έφαγε τον παραπάνω χρόνο είναι το να λειτουργήσει σωστά το πείραμα στο οποίο αλλάζω την τιμή της άδειας και αφήνω όλα τα υπόλοιπα να ισορροπήσουν σε κάποια συγκεκριμένη τιμή. Αυτό όμως δεν είναι σωστό όπως θα δούμε στην συνέχεια, παρ' όλα αυτά εγώ συνε΄χισα να το προσπαθώ. Δεν πήγε πολύ καλά αυτό. 
	\item Έγινε κάποιο διάβασμα σε ασκήσεις για Fair. Distribution. 
		Εδώ το κείμενο πρότεινε διάφορους τρόπους να μοιραστεί ένα αγαθό. Ενδεικτικά υπήρχαν τα παρακάτω:
		1) Αναλογική λύση, 2) Ίσο πλεόνασμα, 3) Ομοίομορφα κέρδη. Στην συνέχεια γινόταν μία σύνδεση του fair distibution με το scheduling. Δεν θυμάμαι από πού τα διάβασα αυτά. 
		\item Μετά διάβασα το Fair Division and Collective Welfare κεφάλαιο 2, μετά από προτροπή της Τζέλας. Το συγκεκριμένο παρουσιάζει 4 αξιώματα of Distributive Justice. Τα αξιώματα αυτά είναι 1) Compensation (ex post equality), 2) Reward, 3) Exogenous rights, 4) Fitness. Ήταν ενδιαφέρον κεφάλαιο.
		\item Μετά η Τζέλα μου είπε να δω λίγο την δομή των πειραμάτων του "Double weighted Bancrupty method to allocate CO2" για να οργανώσουμε με αντίστοιχο τρόπο και τα δικά μας πειράματα. Προφανώς εκείνη τη στιγμή δεν κατάλαβα καθόλου το assignement διπλά. Πρώτα γιατί διάβασα το "Using Bankrupty rules to allocate CO2 emission permits", που νόμιζα πως είναι το ίδιο άρθρο. Μετά κατάλαβα πως ήταν άλλο και διάβασα το σωστό. Μέσα σε αυτήν την διαδικασία ποτέ δεν μου πέρασε από το μυαλό πως η Τζέλα δεν μου είπε να κατάλαβα αναλυτικά τον μηχανισμό του, απλά να δω την δομή με την οποία παρουσιάζουν τα αποτελέσματά τους. Προφανώς απέτυχα εντελώς σε αυτό, γιατί διπλά δεν κατάλαβα ποια ήταν η αποστολή μου. Αυτό μόνο του κόστισε 3 μέρες. 
		\item Εδώ κάπου επέστρεψε ο κύριος Φωτάκης από την Γαλλία. Η αλήθεια είναι πως του πήρε ελάχιστο χρόνο να μου πει πως  το πείραμα αυτό είναι λάθςο και δεν οδηγεί στην σωστή λύση. Έπρεπε να έχει λυθεί η οικονομία μαθηματικά και από εκεί να βρεθεί η ισορροπία. 
		\item Μετά διάβασα από το βιβλίο Enviromental Economics το κεφάλαιο 3, ώστε να πάω μετά στο 8 που πραγματικά με ενδιέφερε. Δεν τελείωσα ποτέ το 8, έπρεπε να διαβάσω την διπλωματική του Παναγιώτη για να πάρω από εκεί το μοντέλο, την τιμή της ισορροπίας και όλα τα σχετικά. Τελικά, το βασικό πρόβλημα είναι πως το μοντέλο του παναγιώτη είναι πολύ διαφορετικό και δεν μπορώ να πάρω έτοιμη την τιμή από εκείνου. Δεν ταίριαζε του Παναγιώτη. Δεν ταίριαζε και του Vanking \& Back-loading emission permits.
		\item Τέλος πάντων για να μην τα πολυλογώ, αυτό το οποίο φαίνεται να είναι η ισορροπία είναι απλά το θεώρημα του Fermat, αλλά το λέμε ισορροπία Nash, Cournot, Walrashian και τα λοιπά, ανάλογα με το ποιες συνθήκες πήραμε. Εδώ μάλλον θα ακολουθήσω το παρακάτω μοντέλο:


\begin{align*}
	\Pi_i &= p(q_i)\cdot q_i - C_A(q_i-x_i)-\tau\cdot (x_i-\Phi(q_i))\\
	\frac{\partial \Pi_i}{\partial x_i} &= C_A'(q_i - x_i) - \tau = 0 \quad \forall i \\
	\frac{\partial \Pi_i}{\partial q_i} &= p'(q_i) q_i + p(q_i) - C_A'(q_i - x_i) + \tau \Phi'(q_i) = 0 \quad \forall i \\
	\sum_{i=0}^n x_i &= Cap
\end{align*}
Η βασική διαφορά είναι πως έχουμε 2 αγορές στις οποίες παίζουν οι εταιρείες. Στην μία αγορά παίζουν μεταξύ τους και τ είναι η τιμή της άδειας την οποία καθορίζουν με βάση ακριβώς το τι τους συμφέρει. Στην άλλη αγορά, θεωρούμε πως η συνάρτηση ζήτησης έχει δημιουργηθεί από τους αγοραστές.
\item Δεν θα πω ψέματα. Δεν μπορώ αυτό να το λύσω εύκολα με το χέρι. Ακόμα και για δύο εταιρείες. Την πρώτη μέρα νόμιζα πως αυτό φταίει γιατί δεν είχα υπολογίσει σωστά ούτε μία φορά όλα τα νούμερα (και μετά αναρωτιέμαι γιατί δεν μπορούσα να περάσω τα πεδία...)
\item Προγραμματίζοντας το πρόβλημα, όλα έγιναν λογικά. Για τον υπολογιστή η επίλυση του συστήματος μη γραμμικών εξισώσεων δεν ήταν απλή. Αλλά τα εύκολα τα λύνει. Το βασικότερο τώρα πρόβλημα είναι πως δεν μπορεί να λύσει πολλές εξισώσεις μαζί. Δοκίμασα απλά παραδείγματα και σε matlab, όπως φαίνεται στο \ref{code2} και σε python  είτε χρησιμοποιώντας τον solver του sympy είτε του Scipy και απέτυχαν και τα δύο με αρκετά απλά νούμερα. 
\item Παράλληλα, η Τζέλα μου έστειλε ένα απόσπασμα από το "Fundamental Methods of Mathematical Economics" το οποίο αναφερόταν σε οικονομία με παραπάνω από 1 προϊόντα όπως επίσης και στην περίπτωση που το προϊόν εξαρτάται από παραπάνω από μία εισόδους.  Μου έστειλε και ένα άλλο βιβλίο στα ελληνικά, αλλά νομίζω πως το πρώτο είναι πολύ πιο σημαντικό. Το βιβλίο αυτό υπάρχει στην κεντρική βιβλιοθήκη στο  330.0151 CHI.
\item Πρέπει εδώ να αναφερθεί πως υπάρχουν τα παρακάτω προβλήματα:
\begin{itemize}
	\item Δεν περιορίζονται οι τιμές λύνοντας απλά τις εξισώσεις, οπότε βγάζει νόημα κάποια εταιρεία να απορροφήσει προϊόν αντί να πουλήσει. Αυτό μπροεί να είναι και πρόβλημα των δεδομένων εισόδου και όχι της επίλυσης, αλλά τέλος πάντων. 
	\item Η αναλυτική λύση του προβλήματος απαιτεί επιπλέον συνθήκες. συγκεκριμένα, το "Fundamental Methods of Mathematical Economics" για 2 αγαθά προτείνει:
			\begin{align*}
		\frac{\partial \Pi_i}{\partial q_i} &= 0 \\
		\frac{\partial \Pi_i}{\partial x_i} &= 0 \\
		\frac{\partial^2 \Pi_i}{\partial x_i^2} &<0\text{, λογικό} \\ 
		\frac{\partial^2 \Pi_i}{\partial q_i^2} &<0\text{, λογικό} \\ 
		\frac{\partial^2 \Pi_i}{\partial x_i^2} \cdot \frac{\partial^2 \Pi_i}{\partial q_i^2} - (\frac{\partial^2 \Pi_i}{\partial q_i \partial x_i })^2 & \geq 0 \text{ Hessian determinant condition}
	\end{align*}

	Που θα έλεγε κανείς πως είναι πολύ περισσότερες συνθήκες από όσες εξετάζω εγώ :Ρ Αλλά προφανώς το πρόβλημα είναι πως μπορεί να είναι πιο περίπλοκη περίπτωση.
	
	
\end{itemize}
\item Ξεκινώντας από αύριο πρέπει να γίνουν άμεσα τα παρακάτω:
\begin{enumerate}
	\item Δανερισμός του βιβλίου για πιο αναλυτικό διάβασμα
	\item Δες τι προτείνει πραγματικά για 2 αγορές και δύο προϊόντα. Δεν φάνηκε να ασχολείται μόνο με μία παράγωγο, αλλά με πολύ περισσότερα.
	\item Μάθε να κάνεις scaling στα δεδομένα και ίσως άλλα τρικ που υπάρχουν για να λύνονται μη γραμμικές εξισώσεις πιο εύκολα υπολογιστικά. Αν αυτό αποτύχει πάμε για τα 2 επόμενα πλάνα. 
	\item Ξαναγράψε το πρόβλημα, αλλά άλλαξε τις μεταλβητές. Η δύσκολη συνάρτηση είναι η $C_A$, οπότε αυτή πρέπει να έχει απλή είσοδο. Για να γίνει αυτό, θα κάνουμε μία αλλαγή μεταβλητής, θέτοντας $a_i = q_i - x_i$ το οποίο θα βελτιώσει πολύ την μορφή της $C_A$. Οπότε το ίδιο πρόβλημα θα γίνει: 
	\begin{align*}
		\Pi_i &= p(q_i) \cdot q_i - C_A(a_i) - \tau \cdot (q_i - a_i - \Phi(q_i)) \\
		\frac{\partial \Pi_i}{\partial a_i} &= - C_A'(a_i) + \tau = 0 \quad \forall i \\
		\frac{\partial \Pi_i}{\partial q_i} &= p'(q_i) q_i + p(q_i) - \tau + \tau \Phi'(q_i) = 0 \quad \forall i \\
		\sum_{i=0}^n q_i - \sum_{i=0}^n a_i &= Cap
	\end{align*}
	\item Η άλλη ιδέα είναι να γραφτεί ολόκληρο το πρώτο πρόβλημα σαν ένα minimization πρόβλημα. Θα πρέπει να έχει τα παρακάτω:
	
	\begin{align*}
		\min_{q_i, x_i} & \sum_{i=1}^n \left( \left(\frac{\partial \Pi_i}{\partial q_i}\right)^2 + \left(\frac{\partial \Pi_i}{\partial x_i}\right)^2 \right) \\
		\text{s.t.} \quad & \frac{\partial^2 \Pi_i}{\partial x_i^2} \leq 0 \quad \forall i \\
		& \frac{\partial^2 \Pi_i}{\partial q_i^2} \leq 0 \quad \forall i \\
		& \frac{\partial^2 \Pi_i}{\partial x_i^2} \cdot \frac{\partial^2 \Pi_i}{\partial q_i^2} - \left( \frac{\partial^2 \Pi_i}{\partial q_i \partial x_i} \right)^2 \geq 0 \quad \forall i \\
			& \sum_{i=1}^n x_i = Cap \\
		& 0 \leq x_i \leq q_i \quad \forall i\\
		& \sum_{i=1}^n x_i = Cap
	\end{align*}
	\item Είχα και μία άλλη ιδέα στην οποία η αντικειμενική συνάρτηση αλλάγη με αυτήν, αλλά μάλλον δεν είναι πολύ καλή ιδέα.
\begin{align*}
	\min_{q_i, x_i} & \sum_{i=1}^n \left(  \frac{\partial \Pi_i}{\partial q_i}  +  \frac{\partial \Pi_i}{\partial x_i}  \right) \\
	\text{s.t.} \quad &  \frac{\partial \Pi_i}{\partial x_i} \geq 0 \quad \forall i \\
	&  \frac{\partial \Pi_i}{\partial q_i} \geq 0 \quad \forall i \\
\end{align*}
\end{enumerate}
	\end{enumerate}
\section{7/10/24}
Ο Θάνος ήρθε από νωρίς σήμερα. Έμοιαζε χαρούμενος, είχε έρθει και το καθαριστικό του πίνακα και ήταν λίγο αγχωμένος με το πρώτο μάθημα του progIntro στη Σεμφε. Τώρα είναι στο μάθημα και ελπίζω να περνά καλά. Ήρθαν διάφορα παιδιά τα οποία δεν έβρισκαν το εργαστήριο μέχρι και στο ΜΟΠ. Πέτυχα και τη Δανάη στη σχολή. Ήταν και αυτή πολύ καλά. Άρχισε να τρώει σαλάτες και γράφει και εκείνη δημοσίευση και πάει και για δεύτερη, παράλληλα ξεκίνησε μεταπτυχιακό στην βιοϊατρική.

Σταματώ τα άσχετα και έρχομαι στα δικά μας. 
\begin{enumerate}
	\item Το βιβλίο "Fundamental Methods of Mathematical Economics" το βρήκα στην βιβλιοθήκη. Δεν είναι αυτό που περίμενα. Είναι μαθηματικά εργαλεία, όπως ακριβώς λέει ο τίτλος του. Δεν ξέρω πού το ξεφύτρωσε η Τζέλα το κεφάλαιο που μου έστειλε και πώς ήταν τόσο στοχευμένο σε αυτό που χρειαζόμουν. Γενικά χάζεψα πολλά βιβλία στην βιβλιοθήκη. Προφανώς είχε δίκιο η Τζέλα, μικροοικονομικής βιβλία έρπεπε να δω. Αλλά και αυτά δεν είναι αναγκαστικό ότι είχαν αυτό που ήθελα. Τουλάχιστον δεν κατάφερα να το βρω.
	\item Εδώ μάλλον καταλήγω και μετά από το ψάξιμο το πρωί πως αυτό που έστειλε η Τζέλα ήταν το πιο σωστό. Χρειάζεται να ισχύει:
		\begin{align*}
			\frac{\partial \Pi_i}{\partial q_i} &= 0 \\
			\frac{\partial \Pi_i}{\partial x_i} &= 0 \\
			\frac{\partial^2 \Pi_i}{\partial x_i^2} &<0\text{, μέγιστο} \\ 
			\frac{\partial^2 \Pi_i}{\partial q_i^2} &<0\text{, μέγιστο} \\ 
			\frac{\partial^2 \Pi_i}{\partial x_i^2} \cdot \frac{\partial^2 \Pi_i}{\partial q_i^2} - (\frac{\partial^2 \Pi_i}{\partial q_i \partial x_i })^2 & \geq 0 \text{ Hessian determinant condition, λόγω αλληλεξάρτησης των μεταβλητών}
		\end{align*}
	\item Δεν έμαθα ακόμα να κάνω scaling. Όμως αυτό στο οποίο είμαι καλός είναι στο να τρέχω κάτι με brute force και να ξαναπροσπαθώ. Με άλλα λόγια. Ενώ ήδη δίνω εξαιρετικά initial guesses στον solver, έβαλα απλά να ξαναπροσπαθεί με μία παράμετρο random. Αλάνι είναι, όλα τα λύνει, όλα τα σκοτώνει. 
	\item το πρόβλημα τώρα είναι πως αφού αποκρίνεται αυτό το σύστημα φαίνονται οι προφανείς αδυναμίες του. Η συνθήκη $\sum_{i=1}^{n}x_i = \text{CAP}$ είναι ακραία προβληματική. Γιατί αποτελέσματα σαν το παρακάτω είναι απολύτως λογικά:
	
\begin{center}
	\textbf{Firm Data Overview}
\end{center}

\vspace{1em}
\begin{tabbing}
	\color{red}{ \textbf{Permit price:}} \= 	\color{red}{-16555.3937} \hspace{3em} \= \textbf{Emission cap:} 5000000 \\
\end{tabbing}

\vspace{1em}
\begin{tabular}{|c|c|c|c|c|c|c|}
	\hline
	\textbf{Name} & \textbf{Sector (PDF)} & \textbf{PCF} & \textbf{ACostF} & \textbf{\(q_i\)} & \textbf{\(x_i\)} & \textbf{Profit \(\Pi_i\)} \\
	\hline
	firm1 & cem(\(100 - 0.1x\)) & \( x \cdot 1 \) & \( 15x + 2x^2 + 2x^3 \) & 59471 & 59392 & -1.42e+10 \\
	firm2 & cem(\(100 - 0.1x\)) & \( x \cdot 0 \) & \( 16x + 3x^2 \) & 1253372 & 1288031 & -3.03e+11 \\
	firm3 & cem(\(100 - 0.1x\)) & \( x \cdot 0 \) & \( 15x + 2.1x^2 + 3x^3 \) & 1248912 & 1248916 & -2.99e+11 \\
	firm4 & ste(\(150 - 0.2x\)) & \( x \cdot 0 \) & \( 12x + 2.2x^2 + 4x^3 \) & 475838 & 475841 & -1.28e+11 \\
	firm5 & ste(\(150 - 0.2x\)) & \( x \cdot 0 \) & \( 20x + 2.3x^2 + 6x^3 \) & 475838 & 475816 & -1.28e+11 \\
	firm6 & ste(\(150 - 0.2x\)) & \( x \cdot 0 \) & \( 10x + 2.4x^2 + 1x^3 \) & 475838 & 475862 & -1.28e+11 \\
	firm7 & pow(\(200 - 0.3x\)) & \( x \cdot 0 \) & \( 10x + 2.5x^2 + 0.5x^3 \) & 317267 & 317258 & -8.53e+10 \\
	firm8 & pow(\(200 - 0.3x\)) & \( x \cdot 0 \) & \( 10x + 2.6x^2 + 1.5x^3 \) & \color{red}{317267} & \color{red}{317276} & -8.53e+10 \\
	firm9 & pow(\(200 - 0.3x\)) & \( x \cdot 0 \) & \( 10x + 2.7x^2 + 2x^3 \) & \color{red}{317267} & \color{red}{317299} & -8.53e+10 \\
	\hline
\end{tabular}
\item Εδώ λοιπόν γίνεται προφανές πως:
\begin{itemize}
	\item η συνθήκη $\sum_{i=1}^{n}x_i \leq \text{CAP}$
	\item η συνθήκη $x_i \leq q_i $
	\item η συνθήκη $\Pi_i \geq 0$
\end{itemize}  είναι παραπάνω από απαραίτητες. Συνεπώς το πρόβλημα είναι πρόβλημα βελτιστοποίησης. Άρα τα αφήνω όλα στην άκρη και πάω στο gurobi αναγκαστικά.
\end{enumerate}

\section{8/10/24}
Στράβωσες τα δοντάκια της βάσης της προέκτασης του γραφείου. Να το φτιάξεις άμεσα. Σήμερα ήρθε και η Τζέλα και ο Σωτήρης και ο κ. Φωτάκης. Ήταν ωραία, το πλάνο μένει ως έχει. Εγώ καλό είναι μέχρι την Τρίτη να έχω κάνει όλα όσα είχα κάνει και παραπάνω, επειδή δεν μένουν πολλές μέρες.
\section{9/10/24} Έφτιαξα τα δοντάκια του γραφείου, πάλι καλά. Ο Αποστόλης είχε το πρωί εργαστήριο progintro αυτό με τα κλασματα. Καλά πιστεύω πως πήγε, αλλά τον κούρασαν. Είχε ντυθεί πάντως ωραία. Εγώ από την άλλη ντυμένος σας κοριτσάκι λυκείου και είμαι απίστευτα κουρασμένος μαζί με έναν πονοκέφαλο, οπότε μάλλον θα γυρίσω σπίτι. Βασικά δεν πρέπει, αλλά δεν την παλεύω. Το πιο σημαντικό που συνέβη σήμερα είναι το ότι έκανα ένα sanity check και ο αλγόριθμος που χρησιμοποιούσα λειτουργεί τελικά. Το οποίο είναι απλά sad. 

Ήταν μία μεγάλη μέρα. Λειτούργησε. Παίζει. Και δεν παίζει απλά. Λύνει και δύσκολα προβλήματα. Έφτιαξα μόνο το σενάριο με τα τετράγωνα, δεν είχα την δύναμη να κάνω κάτι πιο εντυπωσιακό. Ίσως θα έπρεπε. Πάντως τώρα πρέπει να φτιαχτεί η συνάρτηση "equilibrium tester". Είναι πολύ σημαντικό, γιατί δεν ξέρω αν είναι αλήθεια τα αποτελέσματά του. 
...
\begin{lstlisting}[language=Python, caption= Sympy (Symbolic Python functions) to Gurobi]
	import sympy as sp
...
\begin{lstlisting}[language=Matlab, caption= Matlab solving system of non-linear equations, label = code2]
	% Define the system of equations
	function F = system_of_equations(vars)
	% Extract variables
	q1 = vars(1); q2 = vars(2); q3 = vars(3);
	q4 = vars(4); q5 = vars(5); q6 = vars(6);
	q7 = vars(7); q8 = vars(8); q9 = vars(9);
	x1 = vars(10); x2 = vars(11); x3 = vars(12);
	x4 = vars(13); x5 = vars(14); x6 = vars(15);
	x7 = vars(16); x8 = vars(17); x9 = vars(18);
	pp = vars(19);
	
	% System of equations
	F = [
	-4.2*q1 - 0.1*q2 - 0.1*q3 + 4*x1 - 9*(q1 - x1)^2 + 85;
	-pp + 4*q1 - 4*x1 + 9*(q1 - x1)^2 + 15;
	-0.1*q1 - 6.2*q2 - 0.1*q3 + 6*x2 + 84;
	-pp + 6*q2 - 6*x2 + 16;
	-0.1*q1 - 0.1*q2 - 4.4*q3 + 4.2*x3 - 9*(q3 - x3)^2 + 85;
	-pp + 4.2*q3 - 4.2*x3 + 9*(q3 - x3)^2 + 15;
	-4.8*q4 - 0.2*q5 - 0.2*q6 + 4.4*x4 - 9*(q4 - x4)^2 + 138;
	-pp + 4.4*q4 - 4.4*x4 + 9*(q4 - x4)^2 + 12;
	-0.2*q4 - 5.0*q5 - 0.2*q6 + 4.6*x5 - 9*(q5 - x5)^2 + 130;
	-pp + 4.6*q5 - 4.6*x5 + 9*(q5 - x5)^2 + 20;
	-0.2*q4 - 0.2*q5 - 5.2*q6 + 4.8*x6 - 9*(q6 - x6)^2 + 140;
	-pp + 4.8*q6 - 4.8*x6 + 9*(q6 - x6)^2 + 10;
	-5.6*q7 - 0.3*q8 - 0.3*q9 + 5.0*x7 - 9*(q7 - x7)^2 + 190;
	-pp + 5.0*q7 - 5.0*x7 + 9*(q7 - x7)^2 + 10;
	-0.3*q7 - 5.8*q8 - 0.3*q9 + 5.2*x8 - 9*(q8 - x8)^2 + 190;
	-pp + 5.2*q8 - 5.2*x8 + 9*(q8 - x8)^2 + 10;
	-0.3*q7 - 0.3*q8 - 6.0*q9 + 5.4*x9 - 9*(q9 - x9)^2 + 190;
	-pp + 5.4*q9 - 5.4*x9 + 9*(q9 - x9)^2 + 10;
	x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 - 2000;
	];
	end
	
	% Initial guess for the variables
	initial_guess = ones(19, 1); % You might need to adjust this depending on the problem
	
	% Set options for fsolve with increased limits
