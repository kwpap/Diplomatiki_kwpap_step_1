...
\begin{itemize}
	...
	\item Η αναλυτική λύση του προβλήματος απαιτεί επιπλέον συνθήκες. συγκεκριμένα, το "Fundamental Methods of Mathematical Economics" για 2 αγαθά προτείνει:
		...
		\frac{\partial^2 \Pi_i}{\partial x_i^2} \cdot \frac{\partial^2 \Pi_i}{\partial q_i^2} - (\frac{\partial^2 \Pi_i}{\partial q_i \partial x_i })^2 & >0 \text{ Hessian determinant condition}
	\end{align*}
