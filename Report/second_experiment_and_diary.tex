...
Επομένως, δεν είναι καθόλυο επρίεργο. Αυτό το οποίο όντως χρειάζεται να μπει σε αυτήν την διαδικασία είναι το Nace code της εταιρείας. Συγκεκριμένα έχουμε \cite{Nace1}:
\begin{verbatim}
